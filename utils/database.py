...
class OperationMysql():
    ...
    def dataWindow(self, table, window_size=50):
        ...
        for i in range(0, window_size):
            ...
            sql = "select ph4,temperature,humidity,o2,time FROM {table} WHERE id={id}".format(table=table,
                                                                                              id=currentId + i)
            try:
    ...
    def getData(self, id, window_size=50, table="sensor_data_formated", step=1):
